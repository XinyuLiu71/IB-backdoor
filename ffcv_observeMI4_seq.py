...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_poison_data_path', type=str, default="data/imagenet10/badnet/0.1/poisoned_test_data.npz", help='path of poisoned test data')
    ...
    # parser.add_argument('--observe_classes', type=list, default=[0,'0_backdoor','0_clean','0_sample',1,2], help='class')
    parser.add_argument('--observe_classes', type=list, default=[0,'0_backdoor','0_clean',1,2], help='class')
